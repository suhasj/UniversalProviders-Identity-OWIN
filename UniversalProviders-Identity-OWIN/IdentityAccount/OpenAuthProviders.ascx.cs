...
namespace UniversalProviders_Identity_OWIN.IdentityAccount
{
    public partial class OpenAuthProviders : System.Web.UI.UserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string redirectUrl = ResolveUrl(String.Format(CultureInfo.InvariantCulture, "~/IdentityAccount/RegisterExternalLogin?{0}={1}&returnUrl={2}", IdentityHelper.ProviderNameKey, provider, ReturnUrl));
