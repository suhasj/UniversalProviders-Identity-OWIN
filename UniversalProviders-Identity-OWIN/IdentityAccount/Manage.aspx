<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="UniversalProviders_Identity_OWIN.IdentityAccount.Manage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="FeaturedContent" runat="server">
    ...
    <section id="externalLoginsForm">
        ...
        <uc:OpenAuthProviders ID="OpenAuthProviders1" runat="server" ReturnUrl="~/IdentityAccount/Manage" />
    </section>
