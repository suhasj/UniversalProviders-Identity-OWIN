<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpenAuthProviders.ascx.cs" Inherits="UniversalProviders_Identity_OWIN.IdentityAccount.OpenAuthProviders" %>
